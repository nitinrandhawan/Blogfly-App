...
function BlogPostCard({content,index}) {
    ...
    let {banner,blog_id,des,publishedAt,title,author:{personal_info:{fullname,username,profile_img}},tags,activity:{total_likes}}=content
...
<p className="my-3 text-xl font-gelasio leading-7 max-sm:hidden md:max-[1100px]:">{des}</p>
